...
#Import Gudz
RUN wget https://raw.githubusercontent.com/krishna6688/Black-Lightning/master/lightningrun.py
RUN wget https://raw.githubusercontent.com/krishna6688/Black-Lightning/master/requirements.txt
#Start Fumkin
